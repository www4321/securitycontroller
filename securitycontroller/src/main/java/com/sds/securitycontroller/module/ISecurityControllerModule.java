 ...
 * @author alexreimers
 */
public interface ISecurityControllerModule {
	...
	void init(SecurityControllerModuleContext context) throws SecurityControllerModuleException;
	...
	void startUp(SecurityControllerModuleContext context);
