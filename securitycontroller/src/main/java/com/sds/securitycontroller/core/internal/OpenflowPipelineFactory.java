...
public class OpenflowPipelineFactory implements ChannelPipelineFactory {
    ...
    public ChannelPipeline getPipeline() throws Exception {
        MessageChannelState state = new MessageChannelState();
        
        ChannelPipeline pipeline = Channels.pipeline();
        pipeline.addLast("ofmessagedecoder", new SecurityMessageDecoder());
        pipeline.addLast("ofmessageencoder", new SecurityMessageEncoder());
