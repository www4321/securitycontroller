...
import com.sds.securitycontroller.core.message.DeviceMessageFactory;
 ...
 * @author readams
 */
public class SecurityMessageDecoder extends FrameDecoder {

    DeviceMessageFactory factory = new BasicFactory();
    ...
    protected Object decode(ChannelHandlerContext ctx, Channel channel,
        ...
        List<DeviceMessage> message = factory.parseMessage(buffer);
        return message;
    }
