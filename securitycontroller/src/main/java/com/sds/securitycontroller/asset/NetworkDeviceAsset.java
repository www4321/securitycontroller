...
public class NetworkDeviceAsset extends Asset {
	...
	public NetworkDeviceAsset(String id, AssetLevel level, String loginUser, String loginPassword, String loginProto,
